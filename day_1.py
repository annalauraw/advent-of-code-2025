...
def _get_dial_position(number):
    ...
    try:
        ...
        if number > 99:
            ...
            number = 100 + number
        return _get_dial_position(number)


# def _zero_crossings(number):
#     """
#     Get the number of times zero is crossed to get to the.
#     """
#     zero_crossings = 0
#     try:
#         assert 0 <= number <= 99
...
def get_next_dial_position(start_position: int, operation: str):
    ...
    new_position = _get_dial_position(new_number)
    return new_position
...
if __name__ == "__main__":
    ...
    for op in operations:
        ...
        next_dial_position = get_next_dial_position(start_position, op)
        ...
        additional_zero_crossings = get_number_of_zero_crossings(start_position, op)
        zero_counter += additional_zero_crossings
